...
export default function Home() {
  return (
    <div className="min-h-screen bg-hacker-black text-hacker-green flex flex-col items-center justify-center p-4">
      <main className="max-w-4xl w-full mt-20">
        ...
        <section className="hacker-border p-6 rounded-lg mb-8">
          ...
          <button className="bg-hacker-green text-hacker-black px-6 py-2 rounded-md font-bold hover:bg-[#00cc00] transition-colors">
